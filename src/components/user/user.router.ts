...
router.post('/user/', [protectedByApiKey, validation(createUserValidation)], createUser);
router.get('/user/:id', readUser);
router.put('/user/:id', [protectedByApiKey, validation(createUserValidation)], updateUser);
